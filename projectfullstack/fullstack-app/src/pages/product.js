//AMBIL DATA KDATABASE NICH JOINT FRONT SM BACK END
...
class Product extends React.Component {
    ...
    componentDidMount() {
        Axios.get('http://localhost:2000/product/getProduct') // AMBIL URL DR API/SERVER KITA YG UD ITA DEFINE, tes dan ambil dr postman
            .then((res)=>{
    ...
    render() {
        // console.log(this.state.data) //cek data yg kita ambil dr db dapet apa engga
